        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            ...
            <div class="border-10">
              <form action="#" method="">
                <div class="">
                  <input type="text" onfocus="this.select();" class="width-dynamic form-text text-muted text-center form-control" value="<?php echo("img(" . $_GET['protocol'] . $_SERVER['SERVER_NAME'] . str_replace($_SERVER['DOCUMENT_ROOT'], '', $_GET['uploadurl']) . ")")?>">
                </div>
